...
<div id="main">
  ...
  width: 1540px; margin-top: -70px;">☰</button> 
     <div type="container" style="margin-top: 3px; background-color: white; width: 1500px; font-size: 35px; padding: 10px; margin-left: -35px;
      box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1); border: none; font-weight: bold;"><p style="font-size: 15px; color: blue; margin-top: 25px;">&nbsp;Dashboard</p>Announcement<br><br></bdir></div><br><br>
